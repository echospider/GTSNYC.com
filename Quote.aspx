<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Site.master" AutoEventWireup="true" CodeFile="Quote.aspx.cs" Inherits="Quote222" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p>
    Please fill this form to get your quote:</p>
    
        <table class="style1" bordercolor="black" align="center"
        >
            <tr>
                <td class="style3">
                    <asp:Label ID="lblFirstName" runat="server" Text="First Name"></asp:Label>
                    <br />
                    <asp:TextBox ID="txtFirsName" runat="server" width="128px"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfvFirsName" runat="server" 
                        ControlToValidate="txtFirsName" ErrorMessage="*" ValidationGroup="Quote"></asp:RequiredFieldValidator>
                </td>
                <td class="style3">
                    ...
                    <asp:RequiredFieldValidator ID="rfvLastName" runat="server" 
                        ControlToValidate="txtLastName" ErrorMessage="*" ValidationGroup="Quote"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="style4" colspan="2">
                    ...
                    <br />
                    <asp:TextBox ID="txtOrg" runat="server" width="364px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style3" colspan="2">
                    ...
                    <br />
                    <asp:TextBox ID="txtAddress1" runat="server" width="364px"></asp:TextBox>
                    <br />
                    <asp:TextBox ID="txtAddress2" runat="server" width="364px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style3">
                    <asp:Label ID="lblTownCity" runat="server" Text=" 	Town / City:"></asp:Label>
                    <br />
                ...
                <td class="style3">
                    ...
                    <br />
                    <asp:DropDownList ID="DrpStateProvince" runat="server" style="margin-top: 0px" 
                        width="128px"><asp:ListItem Value="" Text=""></asp:ListItem>
...
<asp:ListItem Value="WY" Text="Wyoming"></asp:ListItem>
            ...
            <tr>
                <td class="style3">
                    <asp:Label ID="lblZip" runat="server" Text="Postal /Zip Code"></asp:Label>
                    <br />
                ...
                <td class="style3">
                    ...
                    <br />
                    <asp:DropDownList ID="DrpCountry" runat="server" width="128px">
...
<asp:ListItem Value="ZW">Zimbabwe</asp:ListItem> 
            ...
            <tr>
                <td class="style3">
                    <asp:Label ID="lblWorkPhone" runat="server" Text="Work Phone Number" 
                        style="text-align: left"></asp:Label>
                    <br />
                    <asp:TextBox ID="txtWorkPhone" runat="server" width="128px"></asp:TextBox>
                </td>
                <td>
                    <asp:Label ID="lblFaxNumber" runat="server" Text="Fax Number"></asp:Label>
                    <br />
                    <asp:TextBox ID="txtFaxPhone" runat="server" width="128px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style3" colspan="2">
                    ...
                    <br />
                    <asp:TextBox ID="txtEmail" runat="server" width="364px"></asp:TextBox>
                    <br />
                    <asp:RequiredFieldValidator ID="rfvEmail" runat="server" 
                        ControlToValidate="txtEmail" ErrorMessage="*" ValidationGroup="Quote"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="revEmail" runat="server" 
                        ControlToValidate="txtEmail" ErrorMessage="Invalid E-Mail Address" 
                        ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" 
                        ValidationGroup="Quote"></asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
                <td class="style3" colspan="2">
                    ...
                    <br />
                    <asp:TextBox ID="TextBox4" runat="server" Height="144px" Width="364px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="style2" colspan="2">
                    <asp:Button ID="btnSubmit" runat="server" style="text-align: center" 
                        Text="Submit" onclick="btnSubmit_Click" ValidationGroup="Quote" />
                </td>
            </tr>
            </table>
